...
echo
echo $pur"==================="$cy" ====================================="
echo $i""$pu"  AUTHOR    :  Sahrul Gunawan  "$i"                    #"
echo $i""$pu"  WhatsApp  :  081229707853        "$i"                #"
echo $i""$pu"  Facebook  :  Sahrul Gunawan                 "$i"     #"
echo $i""$pu"  YOUTUBE   :  Android Top4"$i"                        #"
echo $i""$pu"  My Group  :  Anonymous indonesia"$i"                 #"
echo $i""$pu"  Version   :  Tool Versi 3.0.6        "$i"            #"
echo $pur"==================="$cy" ====================================="
echo
...
echo
echo $pur"Root Sahrul Gunawan ["$pur"PILIH NOMORNYA"$pur"]"
echo
read -p"Sahrul Gunawan :~# " pil
